    ...
    <div className="relative">
      ...
      {!emailSent ? (
        <Card className="w-[400px]">
            ...
            <div className="grid gap-4">
              ...
              >
                <Button
                  ...
                  disabled={loading}
                  onClick={() => handleSignInSocials("google")}
                >
                  <svg
                ...
                {/* <Button
                  ...
                  className={cn("w-full gap-2")}
                  disabled={loading}
                  onClick={() => handleSignInSocials("apple")}
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="1em"
          ...
          <CardFooter>
            <div className="flex flex-col w-full border-t py-4 space-y-3">
        ...
        <Card className="w-96 bg-green-50 border-green-500 border">
